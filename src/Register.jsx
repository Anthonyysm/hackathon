...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Salvar dados básicos do usuário na coleção 'users'
      ...
      // Se for psicólogo, salvar dados específicos na coleção 'PsychologistAccount'
      if (role === 'psicologo') {
        await setDoc(doc(db, 'PsychologistAccount', user.uid), {
          ...
          totalSessions: 0,
          availableSlots: ['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00'], // Horários padrão
          languages: ['Português'],
          education: 'Psicologia',
          approach: formData.specialty, // Usar especialidade como abordagem inicial
          certifications: [],
          insurance: false,
          virtualSessions: formData.acceptsOnline,
