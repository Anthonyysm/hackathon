...
class Session(models.Model):
    ...
    psychologist = models.ForeignKey(CustomUser, on_delete=models.PROTECT, related_name='psychologist_sessions', null=True)
    user = models.ForeignKey(CustomUser, on_delete=models.PROTECT, related_name='user_sessions', null=True)
